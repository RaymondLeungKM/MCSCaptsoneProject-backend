...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('related_word_id', sa.String(), sa.ForeignKey('words.id', ondelete='CASCADE'), nullable=False),
        sa.Column('relationship_type', relationship_type_enum, nullable=False, server_default='semantic'),
        ...
        sa.UniqueConstraint('word_id', 'related_word_id', 'relationship_type', name='uq_word_relationship'),
    )
